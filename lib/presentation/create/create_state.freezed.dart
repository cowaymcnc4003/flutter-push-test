...
mixin _$CreateState {
  ...
  @override
  String toString() {
    return 'CreateState(title: $title, message: $message, selectedTarget: $selectedTarget, selectedRepeat: $selectedRepeat, selectedTime: $selectedTime, selectedDays: $selectedDays, startDate: $startDate, endDate: $endDate)';
  }
}
